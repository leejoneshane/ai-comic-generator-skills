...
description: AIGC 3D/2D Manga Integrated Development Environment (IDE) pipeline skills. Automates world-building, character Turnarounds, storyboard scripting, direct drawing integration (Gemini / Nano Banana 2), quality reviews, natural sorted PDF packaging, and environment initialization.
license: MIT
---
